...
class Magestore_Inventorywarehouse_Block_Adminhtml_Sendstock_Renderer_ProLocationSendstock extends Mage_Adminhtml_Block_Widget_Grid_Column_Renderer_Abstract {
    ...
    public function render(Varien_Object $row) {
        ...
        $locationFrom=Mage::helper('inventoryfulfillment')->getProductLocation($warehouseIdFrom,$productId);
        $locationTo=Mage::helper('inventoryfulfillment')->getProductLocation($warehouseIdTo,$productId);
        if(!$locationFrom){
