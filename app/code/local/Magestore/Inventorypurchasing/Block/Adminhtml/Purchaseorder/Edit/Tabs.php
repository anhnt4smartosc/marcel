...
//        }
    ...
    protected function _beforeToHtml()
    {
        ...
        if($this->getRequest()->getParam('id')){
            ...
            if($purchaseorder->getStatus() == Magestore_Inventorypurchasing_Model_Purchaseorder::COMPLETE_STATUS
                    && $purchaseorder->getCompleteBefore()){
                $this->addTab('notreceive_section',array(
                    'label'     => Mage::helper('inventorypurchasing')->__('Missed Items'),
                    'title'     => Mage::helper('inventorypurchasing')->__('Missed Items'),
