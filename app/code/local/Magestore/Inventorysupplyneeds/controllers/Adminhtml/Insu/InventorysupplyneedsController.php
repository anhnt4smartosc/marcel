...
class Magestore_Inventorysupplyneeds_Adminhtml_Insu_InventorysupplyneedsController extends Magestore_Inventoryplus_Controller_Action {
     ...
     * @var string
     */
    protected $_menu_path = 'inventoryplus/stock_in/purchaseorder/po_supplyneeds';
    ...
    public function viewpoAction() {
        ...
        if($draftPO->getType() == Magestore_Inventorysupplyneeds_Model_Draftpo::SUPPLYNEED_TYPE)
            $this->_setActiveMenu($this->_menu_path);
        if($draftPO->getType() == Magestore_Inventorysupplyneeds_Model_Draftpo::LOWSTOCK_TYPE)
            $this->_setActiveMenu('inventoryplus/stock_in/purchaseorder/po_lowstock');
        if($draftPO->getType() == Magestore_Inventorysupplyneeds_Model_Draftpo::PENDINGORDER_TYPE)
            $this->_setActiveMenu('inventoryplus/stock_in/purchaseorder/po_pendingorder');        
        $this->renderLayout();
    }
    ...
    public function createpoAction() {
        ...
        try {
            ...
            $model->setType(Magestore_Inventorysupplyneeds_Model_Draftpo::SUPPLYNEED_TYPE);
            $model->create();
    ...
    public function deletepoAction() {
        ...
        try {
            ...
            if($type == Magestore_Inventorysupplyneeds_Model_Draftpo::SUPPLYNEED_TYPE)
                return $this->_redirect('*/*/index');
            if($type == Magestore_Inventorysupplyneeds_Model_Draftpo::LOWSTOCK_TYPE)
                return $this->_redirect('adminhtml/inpu_lowstock/index');   
            if($type == Magestore_Inventorysupplyneeds_Model_Draftpo::PENDINGORDER_TYPE)
